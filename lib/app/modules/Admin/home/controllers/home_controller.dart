...
import 'package:delivery_food/app/modules/Admin/home/services/home_service.dart';
...
class HomeAdminController extends GetxController {
 ...
 List<String> etatnom = [
  ...
  void fetchMyCommandStatus() async {
    isColisLoading(true);
    try {
      List<dynamic> list = await HomeAdminService.getCommandInfo();
      commandStatus = list;
    } finally {
      isColisLoading(false);
    }
  ...
  void fetchStatusPaieInfo() async {
    ...
    try {
      List<dynamic> list = await HomeAdminService.getStatPaieInfo();
  ...
  /*List<Comande> comande = [
    Comande(
        title: "Assigné",
        img: "assets/images/deliveryman.png",
        number: 10
    ),Comande(
        title: "HorsZone",
        img: "assets/images/no-wifi.png",
        number: 22
    ),Comande(
        title: "En cours",
        ...
        title: "Livré",
        img: "assets/images/package orange.png",
        number: 10
    ),Comande(
        title: "PDR",
        ...
        title: "Reporter",
        img: "assets/images/police orange.png",
        number: 149
    ),
  ];*/
}
