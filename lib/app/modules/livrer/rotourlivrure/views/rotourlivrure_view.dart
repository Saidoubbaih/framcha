...
class RotourlivrureView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    RotourlivrureController controller = Get.find<RotourlivrureController>();
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: GetBuilder< RotourlivrureController>(
                  builder: (_dx) => Card(
                    elevation: 2,
                    shadowColor: Helper.getColorFromHex("#000000"),
                    shape: RoundedRectangleBorder(
